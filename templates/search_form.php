        <div id="search_form">
			<form action="database/search_restaurant.php" method="get">
				<label>SEARCH FOR<input type="text" id="adv_search_field"
					<?php
						if(isset($_GET['searchfor']))
							echo 'value="'.urldecode($_GET['searchfor']).'"';	
					?> 
					name="search_field"></label>
				...
				<input type="submit" id="adv_search_button" value="Search">
			</form>
		</div>
